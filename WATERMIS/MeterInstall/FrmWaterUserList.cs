...
{
    public partial class FrmWaterUserList : Form
    {
        public FrmWaterUserList()
        {
            InitializeComponent();
        }
...
FROM User_Append UA,Meter_Install_Single MIS ,waterUser W LEFT JOIN waterUserType WUT ON W.waterUserTypeId=WUT.waterUserTypeId LEFT JOIN waterUserHouseType WUH ON 
