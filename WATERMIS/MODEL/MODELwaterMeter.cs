...
namespace MODEL
{
    public class MODELwaterMeter
    {
        private string _waterMeterId;
        private string _waterMeterNo;
        private int _waterMeterStartNumber;
        ...
        private string _ISUSECHANGE;
        private string _CHANGEMONTH;
        private string _waterMeterTypeIdChange;
        ...
        public int waterMeterStartNumber
        {
            get
            {
                return _waterMeterStartNumber;
            }
            set
            {
                _waterMeterStartNumber = value;
            }
        }
        ...
        public string waterMeterTypeIdChange
        {
            get
            {
                return _waterMeterTypeIdChange;
            }
            set
            {
                _waterMeterTypeIdChange = value;
            }
        }
        ...
        public string WATERMETERLOCKNO
        {
            get
            {
                return _WATERMETERLOCKNO;
            }
            set
            {
                _WATERMETERLOCKNO = value;
            }
        }
        ...
        public DateTime waterMeterProofreadingDate
        {
            get
            {
                return _waterMeterProofreadingDate;
            }
            set
            {
                _waterMeterProofreadingDate = value;
            }
        }
        public DateTime STARTUSEDATETIME
        {
            get
            {
                return _STARTUSEDATETIME;
            }
            set
            {
                _STARTUSEDATETIME = value;
            }
        }
        public int waterMeteProofreadingPeriod
        {
            get
            {
                return _waterMeteProofreadingPeriod;
            }
            set
            {
                _waterMeteProofreadingPeriod = value;
            }
        }
