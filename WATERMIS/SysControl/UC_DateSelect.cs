...
{
    public partial class UC_DateSelect : UserControl
    {
        public UC_DateSelect()
        {
            InitializeComponent();
        }
        Messages mes = new Messages();
        private void UC_DateSelect_Load(object sender, EventArgs e)
        {
        ...
        {
            get { _DayEnd = dtpEnd.Value; return _DayEnd; }
            set { _DayEnd = value; }
        }
